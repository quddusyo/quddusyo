...
- 🌱 Currently learning: OSCP, DevSecOps, and building faith-based tools  
...
- 🕵️‍♂️ [Phishing Link Detector](https://github.com/your-repo) — Tool to scan and validate suspicious URLs  
- 🧰 [Windows Log Backup Script](https://github.com/your-repo) — Auto backup for Windows Event Logs
